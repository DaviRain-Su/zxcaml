...
# The script owns one temporary Surfpool process and one temporary keypair,
...
case "$FILE_OUT" in
  *ELF*shared\ object*) ;;
  *)
    echo "ERROR: BPF build did not produce a loadable ELF shared object." >&2
    exit 1
    ;;
esac
