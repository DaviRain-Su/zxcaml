...
test "omlz_fmt_golden: poly_variant snapshot is bytewise idempotent" {
    const allocator = std.testing.allocator;
    const io = std.testing.io;
    const cwd = std.Io.Dir.cwd();

    const input_path = "tests/golden/fmt/poly_variant.input.ml";
    const expected_path = "tests/golden/fmt/poly_variant.expected.ml";
...
test "omlz_fmt_golden: functor_decl snapshot is bytewise idempotent" {
    const allocator = std.testing.allocator;
    const io = std.testing.io;
    const cwd = std.Io.Dir.cwd();

    const input_path = "tests/golden/fmt/functor_decl.input.ml";
    const expected_path = "tests/golden/fmt/functor_decl.expected.ml";
...
test "omlz_fmt_golden: class_decl snapshot is bytewise idempotent" {
    const allocator = std.testing.allocator;
    const io = std.testing.io;
    const cwd = std.Io.Dir.cwd();

    const input_path = "tests/golden/fmt/class_decl.input.ml";
    const expected_path = "tests/golden/fmt/class_decl.expected.ml";
...
test "omlz_fmt_golden: poly_type_var snapshot is bytewise idempotent" {
    const allocator = std.testing.allocator;
    const io = std.testing.io;
    const cwd = std.Io.Dir.cwd();

    const input_path = "tests/golden/fmt/poly_type_var.input.ml";
    const expected_path = "tests/golden/fmt/poly_type_var.expected.ml";
...
test "omlz_fmt_golden: labelled_args snapshot is bytewise idempotent" {
    const allocator = std.testing.allocator;
    const io = std.testing.io;
    const cwd = std.Io.Dir.cwd();

    const input_path = "tests/golden/fmt/labelled_args.input.ml";
    const expected_path = "tests/golden/fmt/labelled_args.expected.ml";
...
test "omlz_fmt_golden: optional_args snapshot is bytewise idempotent" {
    const allocator = std.testing.allocator;
    const io = std.testing.io;
    const cwd = std.Io.Dir.cwd();
