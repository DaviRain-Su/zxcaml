//! Wire-format decoding for the M1 P3 ZxCaml frontend S-expression format.
//!
//! RESPONSIBILITIES:
...
const Loc = ttree_types.Loc;
const Module = ttree_types.Module;
const Decl = ttree_types.Decl;
const LetDecl = ttree_types.LetDecl;
const LetRecBinding = ttree_types.LetRecBinding;
const LetRecGroupDecl = ttree_types.LetRecGroupDecl;
const ExternalDecl = ttree_types.ExternalDecl;
const ExternalTypeExpr = ttree_types.ExternalTypeExpr;
const ExternalTypeRef = ttree_types.ExternalTypeRef;
const ExternalTypeArrow = ttree_types.ExternalTypeArrow;
const TypeDecl = ttree_types.TypeDecl;
const TypeVariant = ttree_types.TypeVariant;
const TupleTypeDecl = ttree_types.TupleTypeDecl;
const RecordTypeDecl = ttree_types.RecordTypeDecl;
const TypeAliasDecl = ttree_types.TypeAliasDecl;
const RecordTypeField = ttree_types.RecordTypeField;
const TypeExpr = ttree_types.TypeExpr;
const TypeRef = ttree_types.TypeRef;
const Expr = ttree_types.Expr;
const RefMake = ttree_types.RefMake;
const RefGet = ttree_types.RefGet;
const RefSet = ttree_types.RefSet;
const ArrayLit = ttree_types.ArrayLit;
const ArrayGet = ttree_types.ArrayGet;
const ArrayLength = ttree_types.ArrayLength;
const ArraySet = ttree_types.ArraySet;
const ArrayMake = ttree_types.ArrayMake;
const Lambda = ttree_types.Lambda;
const App = ttree_types.App;
const LetExpr = ttree_types.LetExpr;
const LetRecGroupExpr = ttree_types.LetRecGroupExpr;
const AssertExpr = ttree_types.AssertExpr;
const IfExpr = ttree_types.IfExpr;
const Prim = ttree_types.Prim;
const Var = ttree_types.Var;
const Ctor = ttree_types.Ctor;
const Tuple = ttree_types.Tuple;
const TupleProj = ttree_types.TupleProj;
const Record = ttree_types.Record;
const RecordExprField = ttree_types.RecordExprField;
const RecordField = ttree_types.RecordField;
const RecordUpdate = ttree_types.RecordUpdate;
const FieldSet = ttree_types.FieldSet;
const Match = ttree_types.Match;
const Arm = ttree_types.Arm;
const Pattern = ttree_types.Pattern;
const PatternConstant = ttree_types.PatternConstant;
const AliasPattern = ttree_types.AliasPattern;
const CtorPattern = ttree_types.CtorPattern;
const RecordPatternField = ttree_types.RecordPatternField;
const Constant = ttree_types.Constant;
