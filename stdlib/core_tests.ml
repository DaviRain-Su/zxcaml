...
let () =
  ...
  assert (Fixed.to_scaled (Fixed.of_int 7) = 7000000);
  assert (Fixed.to_int_trunc (Fixed.of_scaled 1234567) = 1);
  assert (Fixed.to_int_floor (Fixed.of_scaled 1999999) = 1);
  assert (Fixed.to_int_ceil (Fixed.of_scaled 1000001) = 2);
  assert (Fixed.to_int_round (Fixed.of_scaled 1500000) = 2);
  assert (Fixed.add (Fixed.of_int 1) (Fixed.of_int 2) = Fixed.of_int 3);
  assert (Fixed.sub (Fixed.of_int 5) (Fixed.of_int 3) = Fixed.of_int 2);
  assert (Fixed.neg (Fixed.of_int 3) = Fixed.of_int (-3));
  assert (Fixed.mul (Fixed.of_scaled 1500000) (Fixed.of_int 2) = Fixed.of_int 3);
  assert (Fixed.div (Fixed.of_int 3) (Fixed.of_int 2) = Fixed.of_scaled 1500000);
  assert (Fixed.ratio 3 2 = Fixed.of_scaled 1500000);
  assert (Fixed.bps 25 = Fixed.of_scaled 2500);
  assert (Fixed.apply 10000 (Fixed.of_scaled 1500000) = 15000);
  assert (Fixed.compare (Fixed.of_int 1) (Fixed.of_int 2) < 0);
  assert (Fixed.equal Fixed.one (Fixed.of_int 1));
  assert (Fixed.min (Fixed.of_int 1) (Fixed.of_int 2) = Fixed.of_int 1);
  assert (Fixed.max (Fixed.of_int 1) (Fixed.of_int 2) = Fixed.of_int 2);
  assert (Amount.fee_bps 10000 30 = 30);
  assert (Amount.discount_bps 10000 30 = 9970);
  assert (Amount.premium_bps 10000 30 = 10030);
  assert (Amount.apply_rate 10000 (Fixed.of_int 2) = 20000);
